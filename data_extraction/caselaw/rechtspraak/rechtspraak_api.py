...
if __name__ == '__main__':
    ...
    url = "https://data.rechtspraak.nl/uitspraken/zoeken?date=2021-01-01&date=2021-12-31"
    print("Rechtspraak dump downloader API")

    parser = argparse.ArgumentParser()
    parser.add_argument('--max', help='Maximum number of ECLIs to retrieve', type=int, required=True)
    parser.add_argument('--starting-date', help='Starting date', required=True)
    ...
    if response_code == 200:
        ...
        if json_object:
            file_name = 'Rechtspraak_' + starting_date + '_' + ending_date
