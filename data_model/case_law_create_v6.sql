...
-- Mon Nov 16 14:03:04 2020
-- Model: Mirror Case Law    Version: 6.0
...
-- Schema case_law
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `case_law` DEFAULT CHARACTER SET utf8 ;
USE `case_law` ;

-- -----------------------------------------------------
-- Table `case_law`.`court`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`court` ;

CREATE TABLE IF NOT EXISTS `case_law`.`court` (
...
-- Table `case_law`.`case`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`case` ;

CREATE TABLE IF NOT EXISTS `case_law`.`case` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `case_law`.`subject`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`subject` ;

CREATE TABLE IF NOT EXISTS `case_law`.`subject` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `case_law`.`case_citation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`case_citation` ;

CREATE TABLE IF NOT EXISTS `case_law`.`case_citation` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `case_law`.`legislation_citation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`legislation_citation` ;

CREATE TABLE IF NOT EXISTS `case_law`.`legislation_citation` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `case_law`.`country`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`country` ;

CREATE TABLE IF NOT EXISTS `case_law`.`country` (
...
-- -----------------------------------------------------
-- Table `case_law`.`case_opinion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`case_opinion` ;

CREATE TABLE IF NOT EXISTS `case_law`.`case_opinion` (
...
-- -----------------------------------------------------
-- Table `case_law`.`case_related_decision`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`case_related_decision` ;

CREATE TABLE IF NOT EXISTS `case_law`.`case_related_decision` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `case_law`.`legal_intelligence_case`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`legal_intelligence_case` ;

CREATE TABLE IF NOT EXISTS `case_law`.`legal_intelligence_case` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `ecli` VARCHAR(60) NOT NULL,
...
-- -----------------------------------------------------
-- Table `case_law`.`case_subject`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`case_subject` ;

CREATE TABLE IF NOT EXISTS `case_law`.`case_subject` (
  `case_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_case_subject_subject`
    ...
    REFERENCES `case_law`.`subject` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `case_law`.`case_country`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `case_law`.`case_country` ;

CREATE TABLE IF NOT EXISTS `case_law`.`case_country` (
  `case_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_case_coutry_country`
    ...
    REFERENCES `case_law`.`country` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
