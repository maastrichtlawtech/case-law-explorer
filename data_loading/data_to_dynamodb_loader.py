...
import csv
from data_loading.utils.row_processors import row_processor_rs_cases, row_processor_rs_opinions, row_processor_li_cases, \
    row_processor_c_citations, row_processor_l_citations
from data_loading.utils.table_truncator import truncate_dynamodb_table
...
def csv_to_dynamo(path_to_csv, table, row_processor):
    ...
    # @TODO: item counter wrong: only count put items or update items that work on items that do not exist yet
