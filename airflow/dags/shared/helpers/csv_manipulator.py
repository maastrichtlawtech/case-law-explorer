...
from shared.data_transformation.utils import read_csv
from shared.definitions.storage_handler import DIR_DATA_PROCESSED
...
def drop_columns(data):
    ...
    data.drop(
        data[-data["WORK HAS RESOURCE TYPE"].str.contains("|".join(types_to_keep))].index,
        inplace=True,
    )
