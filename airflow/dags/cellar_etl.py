...
from definitions.storage_handler import Storage, get_path_raw, CSV_CELLAR_CASES, JSON_FULL_TEXT_CELLAR, TXT_CELLAR_EDGES, TXT_CELLAR_NODES
...
def cellar_etl(**kwargs):
    ...
    if os.path.exists(output_path):
        ...
        end_time = time.time()
        logging.info(f"Time taken for Cellar extraction: {time.strftime('%H:%M:%S', time.gmtime(end_time - start_time))}")
