...
CREATE TABLE IF NOT EXISTS `caselaw`.`court` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `authority_id_UNIQUE` (`id` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `caselaw`.`legal_intelligence_case` (
  `idlegal_intelligence_case` INT NOT NULL,
  `PublicationDate` DATE NULL COMMENT 'The date on which the court decision was first published',
  ...
  `DisplayTitile` VARCHAR(255) NULL,
  `DisplaySubtitile` VARCHAR(255) NULL,
  `OriginalUrl` VARCHAR(255) NULL,
  `Jurisidiction` VARCHAR(255) NULL,
  `DocumentType` VARCHAR(255) NULL,
  `LawArea` VARCHAR(255) NULL,
  ...
  PRIMARY KEY (`idlegal_intelligence_case`),
  INDEX `case_number` (`CaseNumber` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `caselaw`.`case` (
  ...
  `court_id1` INT NOT NULL,
  PRIMARY KEY (`id`, `ecli`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_case_court1_idx` (`court_id1` ASC) VISIBLE,
  CONSTRAINT `fk_case_court1`
    FOREIGN KEY (`court_id1`)
    REFERENCES `caselaw`.`court` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_case_LI_case`
    FOREIGN KEY (`id`)
    REFERENCES `caselaw`.`legal_intelligence_case` (`CaseNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `caselaw`.`subject` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_subject_case1_idx` (`case_id1` ASC) VISIBLE,
  CONSTRAINT `fk_subject_case1`
...
CREATE TABLE IF NOT EXISTS `caselaw`.`case_citation` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_case_citation_case1_idx` (`case_id1` ASC) VISIBLE,
  CONSTRAINT `fk_case_citation_case1`
    FOREIGN KEY (`case_id1`)
    REFERENCES `caselaw`.`case` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `caselaw`.`legislation_citation` (
  ...
  `case_id1` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `citation_id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_legislation_citation_case1_idx` (`case_id1` ASC) VISIBLE,
  CONSTRAINT `fk_legislation_citation_case1`
    FOREIGN KEY (`case_id1`)
    REFERENCES `caselaw`.`case` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `caselaw`.`country` (
  ...
  `population` INT NULL COMMENT 'The total population of the country',
  `eea` BINARY NULL COMMENT 'Is this country part of the European Economic Area (EEA) countries?',
  `case_id` INT NOT NULL,
  `case_id1` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_country_case1_idx` (`case_id1` ASC) VISIBLE,
  CONSTRAINT `fk_country_case1`
    FOREIGN KEY (`case_id1`)
    REFERENCES `caselaw`.`case` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `caselaw`.`case_opinion` (
  ...
  `ecli` VARCHAR(255) NULL COMMENT 'The European Case Law Identifier (ECLI) for the case being opined',
  `case_id` INT NOT NULL,
  `case_id1` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_case_opinion_case1_idx` (`case_id1` ASC) VISIBLE,
  CONSTRAINT `fk_case_opinion_case1`
    FOREIGN KEY (`case_id1`)
    REFERENCES `caselaw`.`case` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
