...
default_args = {"owner": "none", "retries": 0}
with DAG(
    ...
    task1 = PythonOperator(task_id="echr_db_setup", python_callable=setup_db)
    ...
    task3 = TriggerDagRunOperator(
        trigger_dag_id="data_loading", task_id="data_loading", wait_for_completion=True
    )
