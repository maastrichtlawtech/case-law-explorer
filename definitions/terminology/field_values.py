"""
The final set of domain names to be used.
...
DEN_HAAG = S_GRAVENHAGE = "'s-Gravenhage"
RECHTBANK = SECTOR_KANTON_RECHTBANK = 'Rechtbank'


"""
Jurisdiction
"""
NL = NEDERLAND = 'NL'  # used for country and language
# to be extended
